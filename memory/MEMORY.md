...
- ▶ **[T022 score operation verified locally; awaiting publication/integration](../tasks/TASK_REVIEW_T022.md)** (2026-09-12). One `core.score` path composes combined evidence, metrics, ratings, overall disclosure, and optional assessments/divergences for both adapters. Full seven-dimension reports add a self-contained score panel; typed floor and failure abstentions remain visually distinct from numeric ratings and from each other. Final gates: 8 focused tests, 570 compatible full-suite tests, Ruff clean, and real CLI overall 65 from 77 cited metrics. Branch is unpushed and unmerged.
