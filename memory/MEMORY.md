...
- ▶ **[T021 assessment verified locally; awaiting publication/integration](../tasks/TASK_REVIEW_T021.md)** (2026-09-12). User approved optional finding severity with a disclosed declared `medium` default. Assessment starts at 100 and deducts declared severity penalties scaled by declared confidence percentages, rounding once and clamping at zero. Rating and assessment remain side by side; divergence carries both inputs, signed direction, and explicit absence provenance. Final gates: 18 focused assessment tests, 52 assessment/findings tests, 562 compatible full-suite tests, Ruff clean. Branch is unpushed and unmerged.
- ▶ **[T020 verified and published; awaiting integration](../tasks/TASK_REVIEW_T020.md)** (recovered and reverified 2026-09-12). Declared arithmetic ratings enforce inclusive coverage floors and typed abstention. Four adversarial review rounds closed seven P1 and four P2 boundary defects, including forged constructors, contradictory abstention provenance, malformed miss values, lying arithmetic methods, noncanonical serialization, and inconsistent coverage summaries. Recovery gates: 66 focused tests and 539 compatible full-suite tests passed; the project `.venv` still lacks `mcp`. `feat/t020-judge` is published to GitHub and remains unmerged.
